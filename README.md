...
This is a demo application cloned from the Figma MCP Server project. It gives [Cursor](https://cursor.sh/), [Windsurf](https://codeium.com/windsurf), [Cline](https://cline.bot/), and other AI-powered coding tools access to your Figma files with this [Model Context Protocol](https://modelcontextprotocol.io/introduction) server.
...
```bash
npx demo_app --figma-api-key=<your-figma-api-key>
```
...
# or
pnpx demo_app --figma-api-key=<your-figma-api-key>

# or
yarn dlx demo_app --figma-api-key=<your-figma-api-key>

# or
bunx demo_app --figma-api-key=<your-figma-api-key>
```
...
The `demo_app` server can be configured by adding the following to your configuration file:
